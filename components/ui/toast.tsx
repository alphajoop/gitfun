...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'border-prLight ring-offset-prLight hover:bg-prGrey focus:ring-prDark group-[.destructive]:border-prGrey group-[.destructive]:hover:text-prLight dark:border-prDark dark:ring-offset-prDark dark:hover:bg-prGrey dark:focus:ring-prLight dark:group-[.destructive]:border-prDark dark:group-[.destructive]:hover:text-prLight inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 focus:ring-2 focus:ring-offset-2 focus:outline-none group-[.destructive]:focus:ring-red-500 disabled:pointer-events-none disabled:opacity-50 dark:group-[.destructive]:hover:border-red-900/30 dark:group-[.destructive]:hover:bg-red-900 dark:group-[.destructive]:focus:ring-red-900',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'text-prDark hover:text-prGrey dark:text-prLight dark:hover:text-prGrey absolute top-2 right-2 rounded-md p-1 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 focus:opacity-100 focus:ring-2 focus:outline-none group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600',
      className,
    )}
    toast-close=""
    {...props}
